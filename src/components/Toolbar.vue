<template>
  <el-drawer v-model="toolbarStore.openToolbar" :withHeader="false" direction="ltr" size="400px">
    <div v-if="routeStore.points.length > 0" class="point-list-container">
      ...
      <VueDraggableNext :list="routeStore.points" @change="handleOrderChange">
        <div v-for="(point, index) in routeStore.points" :key="index" class="draggable-element">
          <el-col :span="2">
          ...
          <el-col :span="4" class="delete-container">
            <el-tooltip content="Supprimer le point">
              <el-button type="danger" :icon="Delete" @click="() => handleDeletePoint(index)" />
            </el-tooltip>
          </el-col>
        </div>
      </VueDraggableNext>
